...
> [!recite]- Introduction
> Entering Heather Square, the gentle scent of blooming heather mingles with the comforting aroma of freshly baked bread. The air is filled with the sounds of jovial chatter as farmers and vendors exchange goods. The square is surrounded by modest store houses and barns, creating an idyllic scene of rural simplicity.

> [!metadata|map]- Map
> ```leaflet
> id: TBD
> image: [[Map_HeatherSquare.png]]
> height: 600px
> width: 640px
> lat: 50
> long: 50
